...
function ProfileCard({
  ...
  return (
    <section
      ...
      id={id}
      className="flex flex-col place-items-center gap-2 text-gray-400 hover:text-white"
    >
  ...
  return (
    <section className="flex cursor-pointer flex-col place-items-center gap-2 text-gray-400">
      <button
        ...
        className=" grid h-[10vw] max-h-[200px] min-h-[84px] w-[10vw] min-w-[84px] max-w-[200px] place-items-center overflow-hidden hover:border-gray-100 hover:bg-gray-400 hover:text-white"
      >
      ...
      <section className="h-screen w-screen">
        <form onSubmit={onSubmit} className="mx-auto my-16 max-w-4xl">
          ...
          <section className="mt-8 flex gap-4">
            <ProfileButton type="submit" buttonType={"primary"}>
              save
            </ProfileButton>
            {/*attirbutes added  */}
            {props.profile.id ? (
